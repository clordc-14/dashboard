const fieldAliases = {
  ...
  unmetNeedScore: ["unmetNeedScore", "该适应症未满足需求程度", "未满足需求程度"],
  safetyScore: ["safetyScore", "安全性"],
  evidenceScore: ["evidenceScore", "证据质量与人群适用性"],
  costEffectivenessScore: ["costEffectivenessScore", "成本-效果阈值", "成本效果阈值"],
  targetPopulationScore: ["targetPopulationScore", "目标人群特征"],
  competitionLifecycleScore: ["competitionLifecycleScore", "竞品与生命周期"],
  lifecycleManagementScore: ["lifecycleManagementScore", "生命周期管理"],
  policyFitScore: ["policyFitScore", "政策导向符合度"],
  southwestValueScore: ["southwestValueScore", "是否与西南核心医院+DTP的优势匹配", "西南核心医院DTP优势匹配", "西南价值"],
  companyCapabilityScore: ["companyCapabilityScore", "厂牌商业化能力强弱", "厂牌商业化能力"],
  totalScore: ["totalScore", "合计", "总分"],
  scoringSystem: ["scoringSystem", "评分系统"],
  scoreStar: ["scoreStar", "星级"],
  rating: ["rating", "评价"],
